...
public class FlyCamera : MonoBehaviour
{
    ...
    public KeyCode initPositionButton { get => _initPositonButton; }
    ...
    private void SetCursorState()
    {
        ...
        if (Input.GetMouseButtonDown(0) && !EventSystem.current.IsPointerOverGameObject() || Input.GetKeyDown(KeyCode.Escape) && _wantedMode != CursorLockMode.Locked)
        {
            _wantedMode = CursorLockMode.Locked;
        }
